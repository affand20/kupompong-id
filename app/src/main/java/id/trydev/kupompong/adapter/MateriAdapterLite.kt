...
class MateriAdapterLite(private val context: Context, val onClick: (Materi)->Unit): RecyclerView.Adapter<MateriAdapterLite.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        return ViewHolder(LayoutInflater.from(context).inflate(R.layout.item_materi_lite, parent, false))
    }
